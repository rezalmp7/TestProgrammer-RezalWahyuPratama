            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url(); ?>produk/create">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_produk" id="inputNamaProduk" aria-describedby="namaProdukHelp" required>
                    </div>
                    <div class="mb-3">
                        <label for="inputHargaProduk" class="form-label">Harga Produk</label>
                        <input type="number" class="form-control" name="harga_produk" id="inputHargaProduk" aria-describedby="hargaProdukHelp" required>
                    </div>
                    <div class="mb-3">
